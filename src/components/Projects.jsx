      ...
      <div className="grid md:grid-cols-2 gap-10">
        {DATA.projects.map((project, index) => (
          <motion.article
            ...
            className="group glass p-2 flex flex-col h-full relative"
          >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tags.map((tag) => (
                  <motion.span 
                    ...
                    className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs font-medium text-slate-300 transition-colors"
                  >
                    {tag}
                  </motion.span>
                ))}
